...
$(function () {
    ...
    L.control.sideBySide(myLayer1, [myLayer2, usa, tigray, paraiba, malawi, makueni2, india, elsalvador, makueni,brazil, bonoeast, upperwest, niger, cameroon, ghana, mamprusi]).addTo(m);
    ...
    window.change_window = function() {
        ...
        if(selected_city == 'elsalvador') {
            m.setView([14.247732, -89.380679], 15)
        }
        ...
        if(selected_city == 'brazil') {
            m.setView([-20.130326, -40.800080], 15)
        }
        ...
        if(selected_city == 'paraiba') {
            m.setView([-22.539943, -44.146629], 15)
        }
