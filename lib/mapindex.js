...
$(function () {
    ...
    L.control.sideBySide(myLayer1, [myLayer2, tigray, makueni, malawi, upperwest, rwanda, niger, cameroon, campeche, elsalvador, ghana, mamprusi]).addTo(m);
    ...
    window.change_window = function() {
        ...
        if(selected_city == 'makueni') {
            m.setView([-2.561161, 38.096274], 15)
        }
        ...
        if(selected_city == 'ghana') {
            m.setView([10.097017, -2.439068], 15)
        }
        if(selected_city == 'mamprusi') {
            m.setView([10.390084, -0.846330], 15)
        }
        if(selected_city == 'upperwest') {
            m.setView([7.398111, -1.269223], 15)
        }
    }
