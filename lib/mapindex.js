...
$(function () {
    ...
    L.control.sideBySide(myLayer1, [myLayer2, tigray, makueni, rwanda, niger]).addTo(m);
    ...
    window.change_window = function() {
        if( selected_city == 'tigray') {
            m.setView([13.59341, 38.19342], 15)
        }
        if(selected_city == 'makueni') {
            m.setView([-1.723374, 37.470204 ], 15)
        }
        if(selected_city == 'rwanda') {
            m.setView([-1.515869, 29.952997], 15)
        }
        if(selected_city == 'niger') {
            m.setView([13.316919, 2.581680], 15)
        }
    }
