...
$(function () {
    ...
    L.control.sideBySide(myLayer1, [myLayer2, tigray, makueni2, elsalvador, makueni,brazil, bonoeast, upperwest, niger, cameroon, ghana, mamprusi]).addTo(m);
    ...
    window.change_window = function() {
        ...
        if(selected_city == 'brazil') {
            m.setView([-20.140326, -40.830080], 15)
        }
