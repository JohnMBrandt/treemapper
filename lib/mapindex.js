...
$(function () {
    ...
    L.control.sideBySide(myLayer1, [myLayer2, tigray, kwahu, campeche, paraiba, malawi, makueni2, india, elsalvador, makueni,brazil, bonoeast, upperwest, niger, cameroon, ghana, mamprusi]).addTo(m);
