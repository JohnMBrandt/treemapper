...
$(function () {
    ...
    L.control.sideBySide(myLayer1, [myLayer2, tigray, makueni2, makueni,brazil, bonoeast, upperwest, niger, cameroon, ghana, mamprusi]).addTo(m);
    ...
    window.change_window = function() {
        if( selected_city == 'tigray') {
            m.setView([13.56341, 38.21382], 15)
        }
        if(selected_city == 'makueni') {
            m.setView([-2.541161, 38.136274], 15)
        }
        ...
        if(selected_city == 'ghana') {
            m.setView([10.119017, -2.400068], 15)
        }
        if(selected_city == 'mamprusi') {
            m.setView([10.410084, -0.816330], 15)
        }
        if(selected_city == 'upperwest') {
            m.setView([7.420111, -1.225223], 15)
        }
        if(selected_city == 'bonoeast') {
            m.setView([7.718058, -0.692011], 15)
        }
        if(selected_city == 'brazil') {
            m.setView([-20.149326, -40.830080], 15)
        }
        if(selected_city == 'makueni-2') {
            m.setView([-1.80509, 37.50563], 15)
        }
    }
