...
$(function () {
    ...
    window.change_window = function() {
        ...
        var item = L.leafletGeotiff(url = "includes/" + selected_city + ".tif",
        ...
        if(selected_city == 'rwanda') {
            m.setView([-1.628663, 30.142521], 15)
        }
        ...
        if(selected_city == 'usa') {
            m.setView([44.622690, -124.067024], 15)
        }
