...
$(function () {
    ...
    window.change_window = function() {
        ...
        if(selected_city == 'elsalvador-imposible') {
            m.setView([13.727334, -90.015579], 15)
        }
        ...
        if(selected_city == 'guatemala-coban') {
            m.setView([15.3, -90.8], 15)
        }
        if(selected_city == 'senegal-tucker-a') {
            m.setView([15.350595, -15.459789], 15)
        }
        if(selected_city == 'peru-shatoja-district') {
            m.setView([-6.566366, -76.759752], 15)
        }
        if(selected_city == 'angola-galanga') {
            m.setView([-12.104782, 15.151222], 15)
        }
        if(selected_city == 'morocco-chefchaouen') {
            m.setView([34.942560, -4.772589], 15)
        }
        if(selected_city == 'georgia-imereti') {
            m.setView([42.223069, 42.603353], 15)
        }
        if(selected_city == 'drc-mai-ndombe') {
            m.setView([-3.696119, 20.362077], 15)
        }
        if(selected_city == 'malawi-salima') {
            m.setView([-13.6, 34.32], 15)
        }
        if(selected_city == 'brazil-para') {
            m.setView([-2.064534, -56.578095], 15)
        }
        if(selected_city == 'brazil-para-2') {
            m.setView([-7.351687, -48.457507  ], 15)
        }
        if(selected_city == 'pakistan-mardan') {
            m.setView([34.355452, 71.945095], 15)
        } 
        if(selected_city == 'botswana-kweneng') {
            m.setView([-24.360968, 25.176526], 15)
        }     
