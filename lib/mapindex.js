...
$(function () {
    ...
    L.control.sideBySide(myLayer1, [myLayer2, tigray, makueni2, india, elsalvador, makueni,brazil, bonoeast, upperwest, niger, cameroon, ghana, mamprusi]).addTo(m);
    ...
    window.change_window = function() {
        ...
        if(selected_city == 'india') {
            m.setView([24.080469, 81.62926], 15)
        }
    }
