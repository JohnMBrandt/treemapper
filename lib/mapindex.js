...
$(function () {
    ...
    var treecover_raw = L.leafletGeotiff(url = "includes/tigray_leaflet2.tif",
                                         options = { band: 0, displayMin: 0.01, displayMax: 1, colorScale: 'viridis', clampLow: false, clampHigh: true })

    treecover_raw.addTo(m);

    var baseMaps = {
        "Grayscale": myLayer1,
        "Streets": treecover_raw
    };
    L.control.sideBySide(baseMaps, myLayer2).addTo(m);
