...
$(function () {
    ...
    var myLayer1 = L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}', {
            minZoom: 12, maxZoom: 17, zIndex: 1}).addTo(m);
    ...
    var myLayer2 = L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}', {
           ...
           minZoom: 12, maxZoom: 17, zIndex:1, pane: 'left'}).setZIndex(-2).addTo(m);
    ...
    window.change_window = function() {
        ...
        if(selected_city == 'honduras') {
            m.setView([14.096664, -88.720304], 14) // 10.596, 14.2722, 10.694, 14.355 upper right
        }
    ...
    if(url_city) {
        url_to_geotiff_file = "https://restoration-hosting.storage.googleapis.com/" + url_city + ".tif";
    }
    else {
        url_to_geotiff_file = "https://restoration-hosting.storage.googleapis.com/" + "niger" + ".tif";
    }
    ...
    if(url_city) {
        ...
        console.log("URL CITY" + selected_city)
        change_window()
    }
