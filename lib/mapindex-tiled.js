...
$(function () {
    ...
    window.change_window = function() {
        ...
        if(selected_city == 'niger-koure') {
            m.setView([13.310919, 2.603680], 15)
        }
        if(selected_city == 'cameroon-mogazang') {
            m.setView([10.77, 14.28], 14) // 10.596, 14.2722, 10.694, 14.355 upper right
        }
